...
const Projectdetail: React.FC = () => {
  ...
  // Finding the project based on the ID from URL params
      ...
      <div className="container mx-auto px-4 my-16">
        <div className="container mx-auto max-w-4xl">
          <div className="bg-black border border-purple-500/20 rounded-xl overflow-hidden shadow-[0_0_25px_rgba(168,85,247,0.1)]">
            <img
              src={project.coverImageUrl} // Corrected reference here
              alt={project.title} // Corrected reference here
            ...
            <div className="p-4 sm:p-8">
              <h1 className="text-2xl sm:text-3xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text">
                {project.title} {/* Corrected reference */}
              </h1>
              ...
              <div className="prose prose-invert max-w-none mb-6 sm:mb-8">
                <div className=" text-cyan-500 text-sm sm:text-base text-white whitespace-pre-line">
                  {project.longDescription} {/* Corrected reference */}
                </div>
              </div>
