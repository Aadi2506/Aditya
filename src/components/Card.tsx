        ...
        <div className="p-4 sm:p-6 relative z-20">
          ...
          <div className="flex gap-3 md:gap-4 items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 text-gray-400 hover:text-red-400 transition-all"
            >
              <ThumbsDown size={20} /> {disLikes}
            </button>
            <button className="ml-auto p-1 md:px-2 md:py-2 bg-black text-purple-400 rounded-lg border border-purple-500/50 hover:border-purple-500 hover:text-white hover:bg-purple-500/10 transition-all duration-300 text-sm">
              View Details
            </button>
          </div>
        </div>
